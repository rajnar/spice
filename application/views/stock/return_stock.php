...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Spice | Return Stock</title>
        ...
        <script>
            $(document).ready(function(){
                ...
                $('.jreturn_stock').live('click',function(){
                    $.ajax({
                        type: "POST",
                        url: '<?php echo site_url();?>stock/returnStockSave',
                        data: $('#return_stock_form').serialize(),
                        beforeSend : function(){
                        },
                        success: function(){
                        },
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            success: function(data){
                                $('#return_stock_details').html(data).show();
                            },
                            complete: function(){
                            }
                        });
    ...
    <body>
        ...
        <div class="container-fluid" style="min-height:400px">
            <div class="row-fluid" id="main_div">
                <div class="span12">
                    <form name="return_stock_form" id="return_stock_form" method="post" >
                        ...
                        <div class="modal-body">
                            ...
                            <div class="btn btn-primary jreturn_stock" id="done">Return</div>
                            
                            <div id="return_stock_details" style="display:none">
