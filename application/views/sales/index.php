        ...
        <script>
            $(document).ready(function(){
                ...
                jQuery("#sales_grid_tbl").jqGrid431({
                    ...
                    datatype: "json",
                    mtype:"POST",
                    colNames:['Invoice Number','Name','Total Sale Amount(Rs.)','Discount(Rs.)','Amount After Discount(Rs.)','Total Amount(Rs.)','Total Amount Paid','Balance Amount','Payment Method','INV Date','Pay Amount'],
                    colModel:[
