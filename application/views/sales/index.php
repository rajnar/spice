        ...
        <script>
            $(document).ready(function(){
                ...
                jQuery("#sales_grid_tbl").jqGrid431({
                    ...
                    datatype: "json",
                    mtype:"POST",
                    colNames:['Invoice Number','Name','Total Sale Amount(Rs.)','Discount(Rs.)','Amount After Discount(Rs.)','VAT(Rs.)','Total Amount(Rs.)','Total Amount Paid','Balance Amount','Payment Method','INV Date','Pay Amount'],
                    colModel:[
                        {name:'invoice_number',index:'invoice_number',width:'8%'},
                        {name:'name',index:'name',width:'10%'},
                        {name:'total_sale_amount',index:'total_sale_amount',width:'10%',align:"right"},
                        ...
                        {name:'total_amount',index:'total_amount',width:'9%',align:"right"},
                        {name:'total_paid',index:'total_paid',width:'10%',align:"right"},
                        {name:'balance',index:'balance',width:'6%',align:"right"},
                        {name:'payment_method',index:'payment_method',width:'6%',align:"left"},
                        {name:'date_added',index:'date_added',width:'6%'},
