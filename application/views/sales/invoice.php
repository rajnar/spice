            ...
            <div class="row-fluid" id="main_div">
                <div class="span12">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <span class="field">Total Sale Amount (Rs):</span>
                            <span class="value"><?php echo number_format($details_rs->total_sale_amount, 2, '.', '') ;?></span>
                        </div>
                        <div>
                            <span class="field">Discount (Rs):</span>
                            <span class="value"><?php echo number_format($details_rs->discount, 2, '.', '');?></span>
                        </div>
                        <div>
                            <span class="field">Payable Amount (Rs):</span>
                            <span class="value"><?php echo number_format($details_rs->amount_after_discount, 2, '.', '');?></span>
                        </div>
                        <div>
                            <span class="field">Paid Amount (Rs):</span>
                            <span class="value"><?php echo number_format($details_rs->amount_paid, 2, '.', '') ;?></span>
                        </div>
                        <div>
                            <span class="field">Balance Amount (Rs):</span>
                            <span class="value"><?php echo number_format($details_rs->balance_amount, 2, '.', '') ;?></span>
                        </div>
                        <div>
