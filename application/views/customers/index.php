            ...
            $(document).ready(function(){
                ...
                $('.jsave_customer').click(function(){
                    $.ajax({
                        ...
                        complete: function(){
                            jQuery("#customers_grid_tbl").trigger("reloadGrid");
                            $('#myCustomer').find('.close').trigger('click');
                        }
                    });
                });
            });
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span2" style="float:right;text-align:right">
                    <a class="btn btn-primary" href="<?php echo site_url();?>customers/customer">Add Customer</a>
                </div>
            </div>
            <div class="row-fluid">
                <div>&nbsp;</div>
