  ...
  -webkit-box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.05);
   ...
   #password div {
    ...
    <div id="password">
        ...
        <div style="margin-left: 64px; margin-top:45px">
                <form id="resetpwd" name="resetpwd" action="#" method="post">
                    <div style="display: block"><input type="hidden" name="id" value="<?php echo '' ?>"></div>
                    ...
                    <div><label>Confirm Password :</label><input type="password" id="conf_password" name="conf_password"  autocomplete="off" style="margin-left: 4px;" /></div>
                    <div><input class="btn" type="submit" name="Change" value="Change" style="margin-left: 143px;margin-top: 5px"> </div>
